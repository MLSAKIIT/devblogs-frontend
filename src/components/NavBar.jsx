...
const NavBar = () => {
  ...
  return (
    ...
    >
      <img className="h-14 sm:h-16" src="/assets/mlsa-logo.png" alt="Logo" />
      ...
      <div className="flex ">
        ...
        <button className="w-fit rounded-xl text-primary text-sm sm:text-base border border-primary px-2 sm:px-3 font-semibold h-10 flex items-center justify-center mr-2 sm:mr-3 duration-200 hover:opacity-80">
          Create Blogs
        </button>

        <button className="w-fit rounded-xl text-white bg-primary text-sm sm:text-base border border-primary px-2 sm:px-3 font-semibold h-10 flex items-center justify-center duration-200 hover:opacity-80">
          Login
        </button>
      </div>
    </nav>
